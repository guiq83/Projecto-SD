...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="ca-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.ulisboa.tecnico.sdis.ws.cli.CAClientApp %CMD_LINE_ARGS%
