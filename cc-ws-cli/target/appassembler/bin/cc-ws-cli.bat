...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="cc-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.ulisboa.tecnico.sdis.ws.cli.CreditCardClientApp %CMD_LINE_ARGS%
